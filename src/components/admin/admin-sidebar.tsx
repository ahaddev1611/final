...
import { LayoutDashboard, Package, BarChart3, Trash2, Calculator, Undo2, Wrench, Tags } from 'lucide-react';

const navItems = [
  { href: '/admin/dashboard', label: 'Dashboard', icon: LayoutDashboard },
  { href: '/admin/dashboard/items', label: 'Manage Items', icon: Package },
  { href: '/admin/dashboard/deals', label: 'Manage Deals', icon: Tags }, // Added Deals link
  ...
  { href: '/admin/dashboard/closing', label: 'Closing System', icon: Calculator },
