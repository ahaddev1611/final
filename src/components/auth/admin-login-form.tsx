...
import { UserCog, LogIn, AlertCircle } from 'lucide-react';
...
async function authenticateAdmin(username?: string, password?: string) {
  ...
  return { success: false, message: 'Invalid credentials. Use admin/password.' };
}
  ...
  return (
    <Card className="w-full max-w-md shadow-xl">
      <CardHeader className="text-center">
        ...
        <CardDescription>Access the ZippyBill management panel.</CardDescription>
      </CardHeader>
